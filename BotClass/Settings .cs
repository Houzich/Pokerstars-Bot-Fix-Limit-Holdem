...
namespace SettingsClass
{
    ...
    public class Settings : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public class _Game
        {
            public double Call_Ñriterion { get; set; } = new double();
            public double Raise_Ñriterion { get; set; } = new double();
        ...
        public class _Graphic_Table
        {
            ...
            public int Ñard_On_Board_Distance { get; set; } = new int();
            ...
            public int Ñard_Rank_Width { get; set; } = new int();
            public int Ñard_Rank_Height { get; set; } = new int();
        ...
        {
            Game.Call_Ñriterion = 0;
            Game.Raise_Ñriterion = 5;
            ...
            Graphic_Table.Ñard_Rank_Width = 18;
            Graphic_Table.Ñard_Rank_Height = 19;
            Graphic_Table.Card_Suit_Rank_Distance_X = 0;
            Graphic_Table.Card_Suit_Rank_Distance_Y = -33;
            Graphic_Table.Ñard_On_Board_Distance = 54;
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                Point p = new Point(board.Card[0].Pixel.Suit.Point.X + Graphic_Table.Ñard_On_Board_Distance * i, board.Card[0].Pixel.Suit.Point.Y);
                ...
                board.Card[i].Rectangle_Rank = new Rectangle(p.X + Graphic_Table.Card_Suit_Rank_Distance_X, p.Y + Graphic_Table.Card_Suit_Rank_Distance_Y, Graphic_Table.Ñard_Rank_Width, Graphic_Table.Ñard_Rank_Height);
            }
            //--------------------------------------------------------------------------------------
            //--------------------------------------------------------------------------------------
            //--------------------------------------------------------------------------------------
            ...
            for (int i = 0; i < 6; i++)
                for (int ii = 0; ii < 2; ii++)
                {
                    ...
                    player[i].Card[ii].Rectangle_Rank = new Rectangle(p.X + Graphic_Table.Card_Suit_Rank_Distance_X, p.Y + Graphic_Table.Card_Suit_Rank_Distance_Y, Graphic_Table.Ñard_Rank_Width, Graphic_Table.Ñard_Rank_Height);
                }
            //Bets Players
            for (int i = 0; i < 6; i++)
            {
