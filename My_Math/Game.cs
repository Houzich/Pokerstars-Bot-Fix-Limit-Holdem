...
namespace My_Math
{
    public class Game
    {
        ...
        public double Call_Ñriterion = new double();
        public double Raise_Ñriterion = new double();
        ...
        {
           Call_Ñriterion = sett.Game.Call_Ñriterion;
           Raise_Ñriterion = sett.Game.Raise_Ñriterion;
        }
        /*##################################################################################################################*/
        /*##################################################################################################################*/
        /*##################################################################################################################*/
        ...
        public void Get_To_Logic(LogicClass.Logic logic)
        {
            ...
            logic.Call_Ñriterion = Call_Ñriterion;
            logic.Raise_Criterion = Raise_Ñriterion;
            logic.Stage = Stage;
